...
def log_validation(vae, text_encoder, tokenizer, unet, args, accelerator, weight_dtype, epoch):
    ...
    for i in range(len(args.validation_prompts)):
        with torch.autocast("cuda"):
            ...
            if not os.path.exists(f"./generated/{args.validation_prompts[i]}"):
                os.mkdir(f",/generated/{args.validation_prompts[i]}")
            image.save(f"./generated/{args.validation_prompts[i]}/epoch-{epoch}.png")
        images.append(image)
